...
public class EndstoneBlock extends NetherrackBlock implements Fertilizable {
	...
	public EndstoneBlock(AbstractBlock.Settings settings) {
		super(settings);
	}
	...
	public void grow(ServerWorld world, Random random, BlockPos pos, BlockState state) {
		...
		if (bl2 && bl) {
			world.setBlockState(pos, random.nextBoolean() ? Blocks.WARPED_NYLIUM.getDefaultState() : Blocks.CRIMSON_NYLIUM.getDefaultState(), net.minecraft.block.Block.NOTIFY_ALL);
		} else if (bl2) {
			world.setBlockState(pos, Blocks.WARPED_NYLIUM.getDefaultState(), net.minecraft.block.Block.NOTIFY_ALL);
		} else if (bl) {
